...
class NutritionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val nutritionInputET : EditText = findViewById(R.id.nutrition_Input)
        val calorieCountET : EditText = findViewById(R.id.calories_Input)
        val recordInputBt : Button = findViewById<Button>(R.id.record_food_button)
