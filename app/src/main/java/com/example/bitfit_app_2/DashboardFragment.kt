...
class DashboardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        averageValueTV = view.findViewById<TextView>(R.id.AverageCaloriesValueTV)
        minValueTV = view.findViewById<TextView>(R.id.MinimumCaloriesValueTV)
        maxValueTV = view.findViewById<TextView>(R.id.MaximumCaloriesValueTV)
